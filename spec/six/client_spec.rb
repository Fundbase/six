RSpec.describe SIX::Client do
  ...
  describe '#initialize' do
    ...
    it 'raises if credentials are invalid' do
      expect do
        described_class.new('CI43937-username', 'pwd')
      end.to raise_exception(SIX::Error, /invalid user or password/)
    end
  ...
  describe '#identify_instrument' do
    ...
    it 'raises if no ISIN provided' do
      expect do
        client.identify_instrument(nil)
      end.to raise_exception(SIX::Error, 'Missing mandatory method\'s argument')
    end
